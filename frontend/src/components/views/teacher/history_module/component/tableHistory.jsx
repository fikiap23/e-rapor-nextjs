  ...
  const Riwayat = [
    {
      ...
      MataPelajaran: { nama: 'Nilai Agama dan Budi Pekerti' },
      Kelas: { nama: 'A1' },
    },
    {
      Tahun: { tahun: '2021/2022' },
      MataPelajaran: { nama: 'Jati Diri' },
      Kelas: { nama: 'A2' },
    },
    {
      Tahun: { tahun: '2021/2022' },
      MataPelajaran: {
        nama: 'Dasar Literasi, Matematika, Sains, Teknologi, Rekayasa, dan Seni',
      },
      Kelas: { nama: 'A3' },
    },
    {
    ...
    <div className="box-header">
        ...
        <table id="riwayat" className="table table-bordered table-striped">
          <thead>
            <tr>
              ...
              <th onClick={() => handleSort('MataPelajaran')}>
                Rombel <i className="fa fa-sort"></i>
              </th>
              <th onClick={() => handleSort('Kelas')}>
                Kelas <i className="fa fa-sort"></i>
              </th>
            </tr>
          </thead>
          <tbody>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <ul className="pagination">
          {Array.from(
            { length: Math.ceil(filteredRiwayat.length / itemsPerPage) },
            (_, i) => (
              <li
                key={i}
