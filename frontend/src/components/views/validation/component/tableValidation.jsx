...
const TableValidation = () => {
  ...
  const ValidationDummy = [
    {
      id: 1,
      Rombel: { nama: 'X IPA 1' },
      KelompokUsia: { rentang: '2-3 tahun' },
    },
    {
      id: 2,
      Rombel: { nama: 'X IPA 2' },
      KelompokUsia: { rentang: '3-4 tahun' },
    },
    {
      id: 3,
      Rombel: { nama: 'X IPA 3' },
      KelompokUsia: { rentang: '4-5 tahun' },
    },
    {
      id: 4,
      Rombel: { nama: 'X IPS 1' },
      KelompokUsia: { rentang: '5-6 tahun' },
    },
    {
      id: 5,
      Rombel: { nama: 'X IPS 2' },
    ...
    {
      id: 7,
      Rombel: { nama: 'X Seni 1' },
      KelompokUsia: { rentang: '4-5 tahun' },
    },
    {
      id: 8,
      Rombel: { nama: 'X Seni 2' },
      KelompokUsia: { rentang: '5-6 tahun' },
    },
    {
      id: 9,
      Rombel: { nama: 'X Seni 3' },
      KelompokUsia: { rentang: '2-3 tahun' },
    },
  ]
  ...
  const filteredValidation = validation.filter(
    (data) =>
  ...
  const currentValidation = filteredValidation.slice(
    indexOfFirstItem,
    ...
    <div className="box-header">
        ...
        <table id="validation" className="table table-bordered table-striped">
          <thead>
            <tr>
              ...
              <th>No</th>
              <th onClick={() => handleSort('Rombel')}>
                Rombel <i className="fa fa-sort"></i>
              </th>
              <th onClick={() => handleSort('KelompokUsia')}>
                Kelompk Usia <i className="fa fa-sort"></i>
              </th>
              <th>Aksi</th>
          ...
          <tbody>
            {currentValidation.map((data, index) => (
              <tr key={index}>
                ...
                <td>
                  <Link
                    href={`/teacher/validation/${data.id}`}
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <ul className="pagination">
          {Array.from(
            { length: Math.ceil(filteredValidation.length / itemsPerPage) },
            (_, i) => (
              <li
                key={i}
