...
const DashboardViewAdmin = () => {
  ...
  const {
    data: dashboardAdmin,
    error: errorDashboardAdmin,
    isFetching: isFetchingDashboardAdmin,
    refetch: refetchDashboardAdmin,
  } = useDashboardAdmin(token)

  useEffect(() => {
    if (dashboardAdmin && errorDashboardAdmin === null && isFetchingDashboardAdmin === false) {
  ...
  }, [dashboardAdmin, errorDashboardAdmin, isFetchingDashboardAdmin, refetchDashboardAdmin])
      ...
      <section className="content">
        ...
        <div className="stats-container">
          <div className="stat-box">
            ...
            <p className="stat-value">{isFetchingDashboardAdmin ?
