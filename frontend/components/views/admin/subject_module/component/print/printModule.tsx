    ...
    return (
        <div className='body'>
            <div className="header">
                ...
                <h6 className='tbl'>TK ERLANGGA CIRACAS ASY SYAMS ISLAMIC SCHOOL | Kelompok Usia 4-5 tahun | Fase Pondasi</h6>
            ...
            <div className='container' style={{ border: '2px solid black', width: '100%' }}>
                <table width="100%" style={{ borderCollapse: 'collapse' }}>
                    <tr>
                        ...
                        <td className="tbl" style={{ paddingLeft: '5px', borderLeft: '2px solid black' }}>Alokasi Waktu</td>
                        <td className="tbl">:</td>
                    ...
                    <tr>
                        ...
                        <td className="tbl" style={{ paddingLeft: '5px', borderLeft: '2px solid black' }}>Model Pembelajaran</td>
                        <td className="tbl">:</td>
                    ...
                    <tr>
                        ...
                        <td className="tbl" style={{ paddingLeft: '5px', borderLeft: '2px solid black' }}>Kata Kunci</td>
                        <td className="tbl">:</td>
            ...
            <div style={{ display: 'flex', marginTop: '10px' }}>
                <p>Tujuan Kegiatan</p><span style={{ textIndent: '3.2em' }}>:</span>
                <div className="ttd" style={{ marginLeft: '20px' }}>
                    <ol className='dashed-list'>
                        <li>
                            <p>Bersyukur atas anugrah Allah SWT karena telah menciptakan manusia yang berakal dan sempurna</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>
                                Berlatih motorik dan kreativitas serta kolaborasi
                            </p>
                        </li>
                    </ol>
            ...
            <table style={{ marginBottom: '10px' }}>
                <tr>
                    ...
                    <td width={25}>:</td>
                    <td>Anak diajak mengenal Identitasku, berdiskusi secara bersama-sama melalui bercakap-cakap dan tanya jawab serta membuat karya imajinasi yang berkaitan dengan Identitasku</td>
                </tr>
            </table>
            ...
            <table style={{ marginBottom: '20px' }}>
                <tr>
                    ...
                    <td width={25}>:</td>
                    <td>Loose parts, plastisin, playdough, kartu gambar, kartu huruf, alat mewarnai, alat melukis, lagu sesuai tema, dll</td>
                </tr>
            </table>
            ...
            <div style={{ display: 'flex', marginTop: '10px' }}>
                <div className="ttd" style={{ marginLeft: '20px' }}>
                    <ol className='dashed-list'>
                        ...
                        <li>
                            <p>Anak melakukan pemeriksaan anggota tubuh seperti: kuku, telinga, mulut dan hidung</p>
                        </li>
                        <li>
                            <p>
                                Anak secara mandiri menyimpan sepatu pada tempatnya dan masuk kelas dengan terti</p>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div style={{ display: 'flex', marginTop: '10px' }}>
                <div className="ttd" style={{ marginLeft: '20px' }}>
                    <ol className='dashed-list'>
                        ...
                        <li>
                            <p>Guru menyampaikan tema/topik hari ini yaitu tentang: Identitasku</p>
                        </li>
                        <li>
                            <p>Guru mengajak anak mengamati/menonton video tentang tema/topik hari ini</p>
                        </li>
                        <li>
                            <p>Guru melakukan kegiatan bercakap-cakap/bernyanyi/bercerita/tanya jawab tentang: Identitasku</p>
                        </li>
                        <li>
            ...
            <p>Kegiatan disajikan dengan menata lingkungan belajar dan anak bebas memilih mana yang akan dilakukan, dengan kegiatan-kegiatan sebagai berikut:</p><span style={{ textIndent: '3.2em' }}>:</span>
            <table className='weekly' border={3} style={{ border: '1px solid black' }}>
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td>Menyimak video tentang aneka binatang yang hidup di air dan bertanya jawab</td>
                        <td>Menyimak video tentang aneka binatang yang hidup di air dan bertanya jawab</td>
                ...
                <div className="ttd" style={{ marginLeft: '20px' }}>
                    <ol className='number-list'>
                        <li>
                            ...
                            <ul className='sub'>
                                <li>
                                    <p>Ajak anak untuk membereskan mainan yang telah dipakainya</p>
                                </li>
                                <li>
                                    <p>Gunakan nyanyian atau permainan agar anak membereskan mainan dengan senang</p>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul className='sub'>
                                ...
                                <li>
                                    <p>Apa yang kamu rasakan saat harus berbagi ide dengan temanmu saat membuat sebuah gambar?</p>
                                </li>
                                <li>
                        ...
                        <li>
                            <p>Memberikan pujian atas perilaku positif yang telah dilakukan anak</p>
                        </li>
                        <li>
            ...
            <table className='weekly' border={3} style={{ border: '1px solid black' }}>
                <thead>
                    <tr>
                        <th scope="col" rowSpan={2}>PENGAMATAN</th>
                        <th scope="col" colSpan={2}>NAMA ANAK</th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td>Bersyukur atas anugrah Allah SWT karena telah menciptakan manusia yang berakal dan sempurna Mengenal identitas diri</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
