...
function LearningAchievementsInput() {
                    ...
                    {inputs.map((input, index) => (
                        <div className="row" key={input.id}>
                            <div className="form-group">
                                <label htmlFor={`input-${input.id}`} className="control-label">Capaian Pembelajaran {index + 1}</label>
                                <div className="input-group" style={{ width: '50%' }}>
                                    ...
                                    <div className="input-group-append">
                                        <button
                                            style={{ marginTop: '10px', backgroundColor: 'green', borderRadius: '10px' }}
                                        ...
                                        {index > 0 && (
                                            <button
                                                style={{ marginTop: '10px', marginLeft: '10px', backgroundColor: 'red', borderRadius: '10px' }}
                                                className="btn btn-sm btn-outline-secondary"
                                                type="button"
...
export default LearningAchievementsInput